...
def _main() -> int:
    ...
    cover_path = f"zajecia/{storage_dir}/{cover_name}" if storage_dir else f"zajecia/{cover_name}"
    thumb_path = f"zajecia/{storage_dir}/{thumb_name}" if storage_dir else f"zajecia/{thumb_name}"
