...
export function HomeFilteredView({ events, places, camps, activities }: HomeFilteredViewProps) {
  ...
  const visiblePlaces     = hasActiveFilters ? filteredPlaces     : places.slice(0, 9);
  const visibleEvents     = hasActiveFilters ? filteredEvents     : events.slice(0, 6);
  const visibleOrganizers = hasActiveFilters ? organizers         : organizers.slice(0, 6);
  const visibleActivities = hasActiveFilters ? filteredActivities : activities.slice(0, 6);
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Floating activity bubbles — full width background */}
        {([
          { emoji: "🎨", size: 76, top: "5%",   left: "55%",  bg: "rgba(255,255,255,0.10)", delay: "0s",    dur: "4.2s" },
          { emoji: "⚽", size: 58, top: "55%",  left: "58%",  bg: "rgba(255,255,255,0.08)", delay: "0.6s",  dur: "3.8s" },
          { emoji: "🎵", size: 68, top: "30%",  left: "68%",  bg: "rgba(255,255,255,0.09)", delay: "1.0s",  dur: "4.6s" },
          { emoji: "📚", size: 54, top: "70%",  left: "63%",  bg: "rgba(255,255,255,0.07)", delay: "0.3s",  dur: "3.5s" },
          { emoji: "🌳", size: 72, top: "10%",  left: "80%",  bg: "rgba(255,255,255,0.09)", delay: "0.8s",  dur: "4.0s" },
          { emoji: "🎭", size: 52, top: "60%",  left: "79%",  bg: "rgba(255,255,255,0.07)", delay: "1.3s",  dur: "4.8s" },
          { emoji: "🤸", size: 62, top: "40%",  left: "88%",  bg: "rgba(255,255,255,0.08)", delay: "0.5s",  dur: "3.9s" },
          { emoji: "🎪", size: 56, top: "78%",  left: "84%",  bg: "rgba(255,255,255,0.07)", delay: "1.1s",  dur: "4.3s" },
          { emoji: "🧩", size: 60, top: "18%",  left: "93%",  bg: "rgba(255,255,255,0.08)", delay: "0.2s",  dur: "4.1s" },
          { emoji: "🎯", size: 50, top: "50%",  left: "96%",  bg: "rgba(255,255,255,0.06)", delay: "0.9s",  dur: "3.7s" },
          { emoji: "🏊", size: 64, top: "-5%",  left: "72%",  bg: "rgba(255,255,255,0.09)", delay: "0.4s",  dur: "4.5s" },
          { emoji: "🎬", size: 54, top: "85%",  left: "70%",  bg: "rgba(255,255,255,0.07)", delay: "1.5s",  dur: "4.2s" },
          { emoji: "🌈", size: 70, top: "25%",  left: "52%",  bg: "rgba(255,255,255,0.06)", delay: "0.7s",  dur: "5.0s" },
          { emoji: "🎠", size: 58, top: "75%",  left: "93%",  bg: "rgba(255,255,255,0.07)", delay: "1.2s",  dur: "3.6s" },
          { emoji: "🧸", size: 50, top: "45%",  left: "75%",  bg: "rgba(255,255,255,0.08)", delay: "0.1s",  dur: "4.4s" },
          { emoji: "🎡", size: 66, top: "62%",  left: "50%",  bg: "rgba(255,255,255,0.07)", delay: "1.4s",  dur: "4.7s" },
        ] as { emoji: string; size: number; top: string; left: string; bg: string; delay: string; dur: string }[]).map((b, i) => (
          <div
            key={i}
            aria-hidden="true"
            className="pointer-events-none absolute flex items-center justify-center rounded-full border border-white/10"
            style={{
              width: b.size,
              height: b.size,
              top: b.top,
              ...
              animation: `heroBubble ${b.dur} ease-in-out ${b.delay} infinite`,
            }}
          >
            {b.emoji}
          </div>
        ...
        {/* Stat tiles — bottom-right corner */}
        <div className="absolute top-5 right-5 sm:top-7 sm:right-7 hidden sm:flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            {[
              ...
              <Link
                key={stat.href}
                href={stat.href}
                className="group flex items-center gap-3 rounded-2xl px-5 py-4 backdrop-blur-md border border-white/35 hover:border-white/60 transition-all duration-150"
        ...
        {/* Sparkle stars */}
        {([
          { top: "15%", left: "48%", size: 12, opacity: 0.35 },
          { top: "65%", left: "61%", size: 9,  opacity: 0.25 },
          { top: "35%", left: "77%", size: 15, opacity: 0.30 },
          { top: "82%", left: "88%", size: 10, opacity: 0.22 },
          { top: "8%",  left: "86%", size: 11, opacity: 0.28 },
          { top: "50%", left: "91%", size: 8,  opacity: 0.20 },
          { top: "28%", left: "59%", size: 13, opacity: 0.28 },
        ] as { top: string; left: string; size: number; opacity: number }[]).map((s, i) => (
          <svg
            key={i}
            aria-hidden="true"
            width={s.size}
        ...
        <div className="container-page relative py-7 md:py-10 pb-10 md:pb-12">
          <div className="max-w-2xl lg:max-w-[52%]">
            ...
            <p className="mt-4 text-[15px] text-white/75 leading-relaxed max-w-lg">
            ...
            <div className="mt-7 flex gap-2 max-w-lg">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full h-12 rounded-xl bg-white pl-11 pr-4 text-[14px] text-foreground placeholder:text-muted-foreground/60 shadow-[0_4px_20px_rgba(0,0,0,0.20)] focus:outline-none focus:ring-2 focus:ring-white/50"
                />
              </div>
              <button
                type="button"
