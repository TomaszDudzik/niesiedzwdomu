...
export default function AdminSourcesPage() {
  ...
  const [viewMode, setViewMode] = useState<"sources" | "events">("events");
  const [adapterNames, setAdapterNames] = useState<string[]>([]);

  const filteredSources = sources.filter(
    (s) => (s.content_type || "wydarzenia") === "wydarzenia"
  );
  ...
  return (
    <div className="container-page py-8">
      ...
      {showForm && (
        <div className="mb-8">
          <SourceForm source={editingSource} defaultContentType={"wydarzenia"} adapterNames={adapterNames} onSave={handleSave}
      ...
      <div className="space-y-3">
        ...
        {!loading && filteredSources.length === 0 && (
          <div className="text-center py-16 text-muted">
            ...
            <p className="text-[14px]">Brak źródeł wydarzeń</p>
