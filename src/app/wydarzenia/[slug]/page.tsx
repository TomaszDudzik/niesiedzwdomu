...
export default async function EventDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="container-page py-5 lg:py-8">
      ...
      <div className="olive-gradient-panel rounded-[28px] px-4 py-5 shadow-[0_24px_70px_rgba(0,0,0,0.28)] sm:px-6 sm:py-6 lg:px-8 lg:py-8 mb-8">
        <div className="grid lg:grid-cols-[476px_1fr_360px] gap-6 lg:gap-8 items-start">
          ...
          <div className="space-y-3">
            <div className="rounded-xl border border-border/70 bg-white/80 p-4 shadow-sm">
              <p className="text-[13px] text-foreground leading-relaxed font-bold">Wydarzenie:</p>
              <p className="mt-1 text-[13px] text-foreground/80 leading-relaxed">
                {event.title}
                {event.description_short ? ` - ${event.description_short}` : ""}
              </p>
