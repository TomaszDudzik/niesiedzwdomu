...
export default async function EventDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="container-page py-8">
      <Link href="/wydarzenia" className="inline-flex items-center gap-1.5 text-[13px] text-muted hover:text-foreground transition-colors mb-8">
      ...
      <div className="grid lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2">
          {event.image_url && (
            <div className="rounded-lg overflow-hidden mb-8 aspect-[16/9] bg-[#FAFAFA]">
            ...
            <div className="rounded-lg border border-border p-5 space-y-4">
              ...
              <div className="space-y-3 text-[13px]">
                <div className="flex items-start gap-2.5">
                  <Calendar size={15} className="text-muted-foreground/50 shrink-0 mt-0.5" />
                  <div>
                ...
                {event.time_start && (
                  <div className="flex items-start gap-2.5">
                    <Clock size={15} className="text-muted-foreground/50 shrink-0 mt-0.5" />
              ...
              {event.source_url && (
                <a href={event.source_url} target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full px-4 py-2 bg-foreground text-white rounded-md text-[13px] font-medium hover:bg-[#333] transition-colors">
