...
export const seoPages: SeoPageConfig[] = [
  {
    ...
    metaTitle: "Odkryj Kraków z dzieckiem | niesiedzwdomu",
    metaDescription:
...

  {
    ...
    metaTitle: "Wydarzenia dla dzieci Kraków | niesiedzwdomu",
    metaDescription:
...

  {
    ...
    metaTitle: "Półkolonie Kraków dla dzieci | niesiedzwdomu",
    metaDescription:
...

  {
    ...
    metaTitle: "Najlepsze place zabaw Kraków | niesiedzwdomu",
    metaDescription:
