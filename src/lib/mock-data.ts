...
export const mockEvents: Event[] = [
  {
    ...
    age_min: 3, age_max: 7, price_from: 25, price_to: 25, is_free: false, category: "spektakl", district: "Stare Miasto",
    street: "ul. Skarbowa 2", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 5, age_max: 10, price_from: 35, price_to: 35, is_free: false, category: "warsztaty", district: "Kazimierz",
    street: "ul. Św. Wawrzyńca 15", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 0, age_max: 12, price_from: null, price_to: null, is_free: true, category: "festyn", district: "Krowodrza",
    street: "al. 3 Maja", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 0, age_max: 3, price_from: 40, price_to: 40, is_free: false, category: "muzyka", district: "Dębniki",
    street: "ul. Marii Konopnickiej 17", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 6, age_max: 12, price_from: 20, price_to: 20, is_free: false, category: "edukacja", district: "Nowa Huta",
    street: "al. Pokoju 68", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 3, age_max: 10, price_from: null, price_to: null, is_free: true, category: "sport", district: "Podgórze",
    street: "ul. Parkowa", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 4, age_max: 10, price_from: 15, price_to: 15, is_free: false, category: "kino", district: "Stare Miasto",
    street: "Rynek Główny 27", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 5, age_max: 12, price_from: 55, price_to: 55, is_free: false, category: "warsztaty", district: "Kazimierz",
    street: "ul. Józefa 18", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 4, age_max: 14, price_from: 30, price_to: 30, is_free: false, category: "edukacja", district: "Inne",
    street: "ul. Daniłowicza 10", city: "Wieliczka", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 2, age_max: 5, price_from: null, price_to: null, is_free: true, category: "edukacja", district: "Stare Miasto",
    street: "ul. Rajska 1", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 5, age_max: 12, price_from: 15, price_to: 15, is_free: false, category: "natura", district: "Krowodrza",
    street: "Błonia", city: "Kraków", lat: null, lng: null,
  ...
  },
  {
    ...
    age_min: 0, age_max: 99, price_from: null, price_to: null, is_free: true, category: "festyn", district: "Stare Miasto",
    street: "Rynek Główny", city: "Kraków", lat: null, lng: null,
...
export const mockCamps: Camp[] = [
  {
    ...
    age_min: 8, age_max: 14, price_from: 2800, price_to: 2800, price: 2800, is_free: false,
    district: "Inne", venue_name: "Ośrodek Przygoda", venue_address: "Pcim, okolice Krakowa",
    street: "Pcim", city: "Pcim",
  ...
  },
  {
    ...
    age_min: 5, age_max: 10, price_from: 650, price_to: 650, price: 650, is_free: false,
    district: "Kazimierz", venue_name: "Pracownia ArtKids", venue_address: "ul. Józefa 24, Kraków",
    street: "ul. Józefa 24", city: "Kraków",
  ...
  },
  {
    ...
    main_category: "polkolonie", season: "lato", duration_days: 5,
    meals_included: true, transport_included: false,
    age_min: 7, age_max: 12, price_from: 750, price_to: 750, price: 750, is_free: false,
    district: "Krowodrza", venue_name: "Centrum Nauki FunLab", venue_address: "ul. Lea 12, Kraków",
    street: "ul. Lea 12", city: "Kraków",
  ...
  },
  {
    ...
    main_category: "polkolonie", season: "lato", duration_days: 5,
    meals_included: true, transport_included: false,
    age_min: 6, age_max: 13, price_from: 800, price_to: 800, price: 800, is_free: false,
    district: "Nowa Huta", venue_name: "Stadion Hutnika", venue_address: "ul. Ptaszyckiego 4, Kraków",
    street: "ul. Ptaszyckiego 4", city: "Kraków",
  ...
  },
  {
    ...
    age_min: 8, age_max: 14, price_from: 350, price_to: 350, price: 350, is_free: false,
    district: "Stare Miasto", venue_name: "Centrum Kultury Rotunda", venue_address: "ul. Oleandry 1, Kraków",
    street: "ul. Oleandry 1", city: "Kraków",
  ...
  },
  {
    ...
    meals_included: true, transport_included: false,
    age_min: 6, age_max: 11, price_from: 600, price_to: 600, price: 600, is_free: false,
    district: "Stare Miasto", venue_name: "Dom Kultury Pod Lipami", venue_address: "ul. Krupnicza 8, Kraków",
    street: "ul. Krupnicza 8", city: "Kraków",
...
export const mockPlaces: Place[] = [
  {
    ...
    street: "al. 3 Maja, 30-062", postcode: "30-062", city: "Kraków", district: "Krowodrza",
  ...
  },
  {
    ...
    street: "ul. Dobrego Pasterza 120, 31-416", postcode: "31-416", city: "Kraków", district: "Prądnik Czerwony",
  ...
  },
  {
    ...
    place_type: "Ruch i aktywność fizyczna", is_indoor: false,
    street: "Bulwary Wiślane", postcode: "", city: "Kraków", district: "Stare Miasto",
  ...
  },
  {
    ...
    place_type: "Szybka rozrywka / atrakcje", is_indoor: true,
    street: "ul. Zakopiańska 62, 30-418", postcode: "30-418", city: "Kraków", district: "Podgórze",
  ...
  },
  {
    ...
    street: "pl. Szczepański 3a, 31-011", postcode: "31-011", city: "Kraków", district: "Stare Miasto",
  ...
  },
  {
    ...
    place_type: "Ruch i aktywność fizyczna", is_indoor: false,
    street: "Park Bednarskiego, 30-534", postcode: "30-534", city: "Kraków", district: "Podgórze",
  ...
  },
  {
    ...
    place_type: "Szybka rozrywka / atrakcje", is_indoor: true,
    street: "ul. Długa 35, 31-146", postcode: "31-146", city: "Kraków", district: "Stare Miasto",
  ...
  },
  {
    ...
    place_type: "Szybka rozrywka / atrakcje", is_indoor: true,
    street: "ul. Wielicka 263, 30-663", postcode: "30-663", city: "Kraków", district: "Podgórze",
